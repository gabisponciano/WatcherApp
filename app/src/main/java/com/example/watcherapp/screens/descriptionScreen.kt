        ...
        Box(modifier = Modifier.height(500.dp),
            ...
            Column (horizontalAlignment = Alignment.Start,
                ...
                Box(modifier = Modifier
                    ...
                    .padding(20.dp)){
                    Column {
                        Text(text = "Mostre seu valor!",
                            fontSize = 18.sp,
                            fontWeight = FontWeight.Bold,
                            color = Color.White
                        )
                        Spacer(modifier = Modifier.height(8.dp))
                        Text(text = "Obrigada a ir para a faculdade contra a vontade, a rebelde Beca não se interessa em participar de atividades extracurriculares, até surgir a oportunidade de ingressar no grupo musical Barden Bella e competir no Campeonato Regional de Música.",
                            fontSize = 16.sp,
                            fontWeight = FontWeight.Normal,
                            color = Color.White
